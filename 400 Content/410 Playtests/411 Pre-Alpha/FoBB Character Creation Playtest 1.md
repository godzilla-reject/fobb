...
```
# Introduction
Welcome to the first playtest for *Fable of the Behemoth Breakers*, a Monster-Hunting Tabletop Roleplaying Game. In this world, you are a *Breaker*, a warrior trained in powerful magic and massive weaponry to engage in combat with Behemoths, creatures that routinely emerge from the Uberwald to attempt to destroy mortal settlements. 

Breakers are organized into Companies, and it is these Companies that strike out into the Uberwald to claim territory and begin new settlements. You won't be making your Company this playtest, but that *is* the planned focus of Playtest 3!

The goals for *this* playtest are as follows:
- Test the basics of Character Creation: I need to know if it works, and if it works well. 
- Get a measure of Character Creation enjoyability. If it sucks to do, it needs work!
- Address early mechanical issues. Right now, as the game is in its infancy, foundational mechanics need to be set in stone.

This playtest is *just* the character creation. There are no test rolls, no equipment, nothing like that. All of that will come in the *next* playtest.

The next section will tell you the materials you need for this playtest; it isn't much, and I've provided most of it!
## Required Materials
The necessary materials you'll need are:
...
- [Your Feedback Form](https://forms.gle/cTnMRPeQyNd4p6qf9).
# Part 1: Character Creation 
Welcome to the main section of the playtest! Before reading further, make sure you've gotten done with Section 1 of the Feedback form. This will save you some time later! 
 
## Attribute Traits
Attribute traits are a Breakers physical, mental and spiritual efforts and statistics; these are the core of your character. 
...
Skill traits are gained by investing Skill Points (SP), up to a limit. This limit is equal to the governing Secondary Attribute trait, unless you are **Gifted** in that Skill.
>[!aside|right] 
>#### Being Gifted
...
***The Math***
For every **five** Skill Levels (*not* Points) a Breaker has in the *Speed* skill trait, they gain an additional +1 space to any Moves they have.
## Creation Overview 
Before you get started on making your first Breaker, make sure you're familiar with the three Traits sections above, then follow the steps as presented!
 
### Step 1. 
Select your Breaker's **Species**; this is what culture they belong to. Record your Base Health, Base Mana, and Base Stamina Derived traits, any abilities gained, and your bonuses to your Primary Attribute traits, on your Breaker sheet. Remember, all three Primary Attribute traits start at 2!
> [!cards]
...
### Step 9. 
Use your starting budget of **crowns** to purchase equipment, including starting armor and weaponry.  For the sake of this playtest, this step is irrelevant, but it'll be featured in the next one!
### Step 10.
Finally, describe your Breaker's appearance, fill out their **biography**, and choose their **name** and **pronouns**!
...
>> - **Edge of Death**
>> When you become **Bloodied**, you **Berserker Rage** as a free action. This is *not* optional. While you are **Bloodied**, your Rage changes in the following ways: Your Physical Resistance is increased by 6, your weapon deals an additional die of damage, and your Dodge lowers by 2 steps.
...
>> - **Divine Light** ●
>> *Mana 4*
>> You engulf an ally or your weapon in radiant divinity. Roll your Faith die twice. If you're targeting a creature (such as an ally or yourself), you heal that creature for the total. If you're targeting your weapon, you deal additional weakness damage on your next Strike equal to the total (*Weakness damage is counted as whatever damage type the target is weakest to*.)
>> - **Warrior's Faith**
...
>> Whenever you use **Soul-Call Chant**, your 
...
>>---
>>> -  ###### **Reaper's Fervor**
>>> *New*: Treat your current *Combo Count* as the number of actions spent for the effect of *Charged* actions.
>>> *Old*: *Combo* actions you perform count as a an action spent for the effects of *Charged* actions. 
>>---
>
>> [!blank]
>> ###### Core Actions
...
>> ###### Core Mechanics
>>> -   ###### **Claw and Fist**
>>> Whenever you make a Breaker Fist *Strike* action, you can declare if it deals impact *or* cutting damage as part of the action. 
>>---
>>> -   ###### **Accel-Clash Driver MK I**
...
# Part 2: Feedback
Now that you've finished up with your playtest, head over to the provided feedback form and begin filling out the next two sections. Once you're done with that, you're done with this playtest! 
# Glossary 1: Tag List 
...
- **Open** An action with this tag can only be used if its the first action of that type you take on your turn. The *type* tags are: Strike, Move, Dodge and Block. 
...
# Conclusion
I'd like to thank you for your time, and I sincerely hope you had fun. If you didn't, then I apologize. Make sure you tell me why; that's how I improve the game! 

I look forward you participating in the next playtest, should you decide to do so. 

Remember hunters, the *Uberwald needs to be tamed, and only the Breakers can do it.*
# Credits 
I'd like to give special thanks to 
- Matthew Blackwelder, for being a creative consultant and proofreader.
- Bay, for giving names to the four long-extinct Behemoths whose souls heed the Caller's chant.
- The rest of my friends, for dealing with many rants, raves, dreams and aspirations. This is for you guys, for us, and it always will be. Game design is STILL hard, but you guys make it so much easier.