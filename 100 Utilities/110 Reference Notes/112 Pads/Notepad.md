...
- Behemoths
	- Mechanical Components 
		- Behemoth Genus: The family that the Behemoth belongs to. Think of the "Rath" family from Monster Hunter.
	...
	- Design Packages
		- Trait Packages 
			...
			- Trait Focuses
				- Defense Focus
					- Base HSM:  12/3/3 (multiplied by Class Value)
					- Base Move: 2
					- Base Dodge Die: d4
					- Base Physical/Elemental Res: 10/10
				- Speed Focus
					- Base HSM: 3/12/3 (multiplied by Class Value)
					- Base Move: 8
					- Base Dodge Die: d10
				...
				- Special Focus
					- Base HSM: 3/3/12 (multiplied by Class Value)
					- Base Move: 4
					- Base Dodge Die: d6
